...
class SkillClient:
    ...
    def get_skills(self, cognitoUserId, characterId):
        general_exception_message = 'An unexpected error occurred when getting the skills.'
        storedProcedure = 'sp_getSkillsByCharacterId'
        response = None
