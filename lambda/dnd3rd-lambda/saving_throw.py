...
class SavingThrowClient:
    def __init__(self, mysql_handler):
        self.handler = mysql_handler

    def get_saving_throws(self, cognitoUserId, characterId):
        general_exception_message = 'An unexpected error occurred when getting the saving throws.'
        storedProcedure = 'sp_getSavingThrowsByCharacterId'
        response = None
