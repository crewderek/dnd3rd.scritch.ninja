...
class ArmorClient:
    ...
    def get_armor(self, cognitoUserId, characterId):
        general_exception_message = 'An unexpected error occurred when getting the feats.'
        storedProcedure = 'sp_getArmorsByCharacterIdJSON'
        response = None
