...
class AbilityClient:
    ...
    def get_abilities(self, cognitoUserId, characterId):
        general_exception_message = 'An unexpected error occurred when getting the abilities.'
        storedProcedure = 'sp_getAbilitiesByCharacterId'
        response = None
